...
export default function PlayerMiniCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "flex w-full items-center gap-3 rounded-lg border border-fw-border bg-fw-surface px-3 py-2.5 text-left transition-colors hover:border-fw-accent/40 hover:bg-fw-surface-hover",
        className
      )}
    >
